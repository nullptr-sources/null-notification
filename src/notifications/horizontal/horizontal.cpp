...
namespace null::notification {
	...
	void c_horizontal::draw() {
		...
		rect_t remaining_time_line_rect{ rect_t{ pos + remaining_time_line_offset }.from_min(vec2_t{ style_t::remaining_time_line_size, size.y - style_t::text_offset.y * 2.f }) };
